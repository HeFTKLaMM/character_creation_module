...
def attack(char_name: str, char_class: str) -> str:
    """Функция активирует навык 'атака' главное героя."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция авктивирует навык 'блокировка урона' главное героя."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция авктивирует навык 'специальное умение' главное героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция выводит выбранный класс и указывает на дальнейшую тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция позволяет выбрать 'класс' главное героя."""
    approve_choice = None
    char_class = None
